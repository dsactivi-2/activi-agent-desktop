export default {
  title: "Welcome to Activi",
  subtitle:
    "Your local AI agent workspace for chat, tools, profiles, and orchestration.",
  ...
  connectRemoteSubtitle: "Enter the URL of a running agent API server.",
