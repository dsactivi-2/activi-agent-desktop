export default {
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a Agente remoto",
  connectRemoteTitle: "Conectarse a Agente remoto",
  connectRemoteSubtitle:
    "Introduce la URL de un servidor de API de agente en ejecución.",
